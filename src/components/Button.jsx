const Button = () => {
  ...
  return (
    <div className="absolute w-24 h-24 bottom-0 left-1/2 transform -translate-x-1/2 -translate-y-5 z-20 flex items-center justify-center group cursor-pointer opacity-0 animate-slideUp">
